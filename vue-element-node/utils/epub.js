...
class EPub extends EventEmitter {
    ...
    getImage(id, callback) {
        // console.log(this.manifest, id, 'coverIdcoverIdcoverIdcoverIdcoverIdcoverId')
        if (this.manifest[id]) {
            ...
            const coverId = Object.keys(this.manifest).find(key => {
                // console.log(this.manifest[key].properties, '..................')
                return this.manifest[key].properties === 'cover-image'
            })
            // console.log(coverId, 'coverIdcoverIdcoverId')
